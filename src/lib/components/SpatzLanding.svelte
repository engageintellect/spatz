...
<div class="">
  ...
  <div class="mockup-browser border border-base-300 shadow-xl mt-5">
    ...
    <div class="overflow-auto">
      ...
      >
        <Icon icon="teenyicons-svelte-solid" class="w-52 h-52 text-base-300" />
        <Icon icon="simple-icons:pocketbase" class="w-52 h-52 text-base-300" />
        <Icon icon="simple-icons:vercel" class="w-52 h-52 text-base-300" />
        <Icon icon="simple-icons:tailwindcss" class="w-52 h-52 text-base-300" />
